...
namespace Unity.Serialization.Binary.Tests
{
    ...
    unsafe partial class BinaryAdapterTests
    {
        ...
        {
            public void Serialize(in BinarySerializationContext<DummyClass> context, DummyClass value)
            {
                
            }

            public DummyClass Deserialize(in BinaryDeserializationContext<DummyClass> context)
            {
                return null;
            }
        }
        ...
        {
            void IBinaryAdapter<ClassWithAdapters>.Serialize(in BinarySerializationContext<ClassWithAdapters> context, ClassWithAdapters value)
            {
                context.Writer->Add(value.A);
            }

            ClassWithAdapters IBinaryAdapter<ClassWithAdapters>.Deserialize(in BinaryDeserializationContext<ClassWithAdapters> context)
            {
